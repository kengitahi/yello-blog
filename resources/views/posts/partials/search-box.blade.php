<div id="search-box" x-data="{query: '{{request('search', '')}}'}">
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            <input
                ...
                type="text" placeholder="Search..." x-model="query"
                x-on:keyup.enter="$dispatch('search', {searchTerm:query})">
        </div>
        <x-button type="submit" x-on:click="$dispatch('search', {searchTerm:query})">
            Search Posts
        </x-button>
